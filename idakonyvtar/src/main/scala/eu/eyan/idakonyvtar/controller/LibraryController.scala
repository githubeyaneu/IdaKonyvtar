...
import eu.eyan.idakonyvtar.text.TextIdaLibrary.ERROR_AT_READING
import eu.eyan.idakonyvtar.text.TextIdaLibrary.NO
import eu.eyan.idakonyvtar.text.TextIdaLibrary.NO_BOOK_FOR_THE_FILTER
import eu.eyan.idakonyvtar.text.TextIdaLibrary.NO_BOOK_IN_THE_LIST
import eu.eyan.idakonyvtar.text.TextIdaLibrary.TITLE
import eu.eyan.idakonyvtar.text.TextIdaLibrary.YES
