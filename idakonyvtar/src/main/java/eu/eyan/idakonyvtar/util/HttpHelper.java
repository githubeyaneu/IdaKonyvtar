...
public class HttpHelper {
	...
	public static String postUrl(final String request,
		...
		// System.out.println("Connection Encoding : "
		...
		// FileUtils.writeStringToFile(new File("C:\\tmp\\test.html"),
		// ret.toString());
		// FileUtils.writeStringToFile(new File("C:\\tmp\\test_" +
		// HttpHelper.ct++ + ".html"), ret.toString());
