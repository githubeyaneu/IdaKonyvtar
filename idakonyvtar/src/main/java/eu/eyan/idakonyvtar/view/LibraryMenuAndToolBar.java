...
public class LibraryMenuAndToolBar {
	...
	public final JButton TOOLBAR_NEW_BOOK = new JButton("Új book",
			new ImageIcon(Resources.getResource("icons/newbook.gif")));
	public final JButton TOOLBAR_BOOK_DELETE = new JButton("Törlés",
			new ImageIcon(Resources.getResource("icons/delete.gif")));
