...
public class ColumnKonfiguration
{
    ...
    {
        MULTIFIELD("MultiMező"),
        AUTOCOMPLETE("AutoComplete"),
        MARC_CODE("MarcKód"),
        REMEMBERING("Emlékező"),
        SHOW_IN_TABLE("Táblázatban");
    ...
    public boolean isTrue(String columnName, ColumnConfigurations columnConfiguration)
    {
        return getValue(columnName, columnConfiguration).equalsIgnoreCase("Igen");
    }

    private String getValue(String columnName, ColumnConfigurations columnConfiguration)
    {
    ...
    public List<Marc> getMarcCodes(String columnName) throws Exception
    {
        ...
        try
        {
            String[] marcCodeTexts = getValue(columnName, ColumnConfigurations.MARC_CODE).split(",");
        ...
        {
            throw new Exception("A Marc kódot nem lehet a configurationból beolvasni: " + columnName);
        }
        return ret;
    }
