...
public class Book extends Model implements Cloneable {
	...
	public void setValue(int columnIndex, final String value) {
		...
		if (value != null /* && !value.equals("") */) {
			...
			firePropertyChange(new BookPropertyChangeEvent(this, "PROP",
					oldValue, value, columnIndex));
		}
	}
	...
	public static class BookPropertyChangeEvent extends PropertyChangeEvent {
		...
		public BookPropertyChangeEvent(Object source, String propertyName,
				Object oldValue, Object newValue, int columnIndex) {
