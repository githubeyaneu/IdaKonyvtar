...
public class BookEditorIsbnTest extends AbstractUiTest
{
    ...
    public void setUp()
    {
        ...
        BookControllerInput bookControllerInput = new BookControllerInput.Builder()
                .withBook(book)
                .withColumns(columns)
                .withColumnConfiguration(new ColumnKonfiguration.Builder(4, columns.size() + 1)
                        .withRow("", MULTIFIELD.getName(), AUTOCOMPLETE.getName(), MARC_CODE.getName())
